    ...
    <div>
      ...
      <b-card id="card" title="Your profile">
        <b-card-body style="margin:40px">
          ...
          <!-- Title -->
          <span style="float:left;">Name title : {{user.Name_Title}}</span>
          <br />
          <br />

          <!-- DoB -->
          <span style="float:left;">Birthday : {{user.DoB}}</span>
          <br />
          <br />

          <!-- Email -->
          <span style="float:left;">Email address : {{user.Email}}</span>
          <br />
          <br />

          <!-- Tel -->
          <span style="float:left;">Phone number : {{user.Tel_No}}</span>
          <br />
          <br />

          <!-- Country -->
          <span style="float:left;">Country : {{user.Customer_Country}}</span>
          <br />
          <br />
        </b-card-body>
      </b-card>
