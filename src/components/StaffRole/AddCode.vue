...
<br>
        <b-button id="button" type='submit' variant="dark" @click="checkAdd()">Add</b-button>
      </div>
    </div>
    <hr />
...
export default {
  ...
  methods: {
    ...
    checkAdd(){
      if(this.cID===null | this.cName===null | this.cDiscount===null
      | this.cLimit===null | this.cStartD===null | this.cExpriedD===null){
